...
#
# Copyright (c) 2022 Kazumoto Kojima <kkojima@rr.iij4u.or.jp>
...
# Example:
# ./colorlight_i5.py --with-ethernet --remote-ip 10.253.253.8 --local-ip 10.253.253.95 --build --load
#
...
class BaseSoC(SoCCore):
    def __init__(self, board="i5", revision="7.0", sys_clk_freq=60e6, with_ethernet=False,
        ...
        # AD9874 SSI ----------------------------------------------------------------------------------
        # Assume that AD9874 SSI IO pin definition like
        # ("ssi", 0,
        ...
        #     IOStandard("LVCMOS33")
        # ),
        # in _io_v7_0 litex-boards's platform/colorlight_i5.py
        self.submodules.ad9874iq = ad9874iq = AD9874IQ(platform, platform.request("ssi"))
